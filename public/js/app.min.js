...
function countDownTimerNew() {
    // Set the date we're counting down to
    // var countDownDate = new Date($('#countdown').attr('data-destroy')).getTime();
    var countDownDate = new Date($('#countdown').data('destroy')).getTime();
    console.log('date: ' + $('#countdown').data('destroy'));
...
// Update the count down every 1 second
    var x = setInterval(function() {
        ...
        var countdown_html = '';
        if (days > 0) {
            countdown_html += days +' days, '
        }
        if (hours > 0) {
            countdown_html += hours +' hours, '
        }
        if (minutes > 0) {
            countdown_html += minutes +' minutes, '
        }
        if (seconds > 0) {
            countdown_html += seconds +' seconds'
        }
        countdown.innerHTML = countdown_html;
...
function countDownTimer() {
    var targetDate = new Date($('#countdown').attr('data-destroy')).getTime(),
    ...
    setInterval(function() {
        ...
        console.log('time:' + countdown_html);

        // countdown.innerHTML = '<ul><li>day<span>' + days + '</span></li><li>hours<span>' + hours + '</span></li><li>minutes<span>' + minutes + '</span></li><li>seconds<span>' + seconds + '</li></ul>';
        // countdown.innerHTML = '<ul><li>day<span>' + days + '</span></li><li>hours<span>' + hours + '</span></li><li>minutes<span>' + minutes + '</span></li><li>seconds<span>' + seconds + '</li></ul>';
    }, 1000);
}
...
// $(function() {
  ...
  // copy link
  $('#copyNote, #link-copy-block').on('click', function(){
...
/*  if ($('#countdown').length) {
    ...
    $('#slct').change(function() {
        if ($(this).val() > 0) {
            $('.checkbox-container').addClass('hide');
        } else {
            $('.checkbox-container').removeClass('hide');
        }
    });
